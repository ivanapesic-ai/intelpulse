  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // IBM Corporate colors
        'ibm-blue': 'hsl(var(--ibm-blue))',
        'ibm-blue-dark': 'hsl(var(--ibm-blue-dark))',
      ...
      boxShadow: {
        'subtle': '0 1px 3px hsl(0 0% 0% / 0.04), 0 1px 2px hsl(0 0% 0% / 0.06)',
        'elevated': '0 4px 12px hsl(0 0% 0% / 0.08)',
        'elevated-lg': '0 8px 24px hsl(0 0% 0% / 0.12)',
      },
    }
  },
