...
-- Percentile-based signal scoring function
-- Ranks technologies within the active set and assigns 0/1/2 based on percentile position
-- Top 20% = Strong (2), Middle 40% = Moderate (1), Bottom 40% = Emerging (0)
...
DECLARE
  ...
  result jsonb;
BEGIN
  -- Count active technologies (those with any data)
